            ...
            <tr style="width: 100%;">
                ...
                <td>
                    <div style="width: 545px; margin:10px;">
                      ...
                      line-height: 1.2rem;
                    ">
                      We are really sorry to inform you that your booking with ${data.userName}, which was scheduled on ${data.bookingDate}, has been canceled. Please read our students' message to you.
                      </p>
                            <p style="
                            margin-top: 0;
                            margin-bottom: 6px;
